...
// all environments
app.set('port', 8585); //process.env.PORT || 8081
...
//сокет сервер
let sockjsEecho = sock.createServer({ sockjs_url: 'http://cdn.jsdelivr.net/sockjs/0.3.4/sockjs.min.js' });
let sockId = [],
    games = [],
    nGame = 0;
    //setConn = new Set();
